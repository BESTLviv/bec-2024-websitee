    ...
    return (
        <footer className="bg-side relative items-center justify-between h-6 flex text-white    ">
            ...
            <div className="flex justify-center items-center  ">
                <a href="https://www.instagram.com/best_lviv/" target="_blank" rel="noopener noreferrer"><Image className="mr-[17px] footer__social transform hover:scale-[1.3] transition-transform duration-500 " src={instagram} alt="" /></a><a target="_blank" rel="noopener noreferrer" href="https://t.me/bestlviv"><Image className="mr-[17px] footer__social transform hover:scale-[1.3] transition-transform duration-500" src={telegram} alt="" /></a><a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/company/bestlviv/"> <Image className="footer__social transform hover:scale-[1.3] transition-transform duration-500" src={linkedin} alt="" /></a>
            </div>
        </footer>
    );
}