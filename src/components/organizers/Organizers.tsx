...
export default function Organizers() {
    ...
    return (
        <article className="organizers relative">
            ...
            <span className=' bg-lines1OrganizersM absolute top-[3%] right-[-61%] bg-no-repeat h-[680px] w-[680px] min-[1024px]:opacity-0 min-[320px]:left-[-0%] min-[389px]:left-[20%] min-[488px]:left-[40%] min-[590px]:scale-[1.2]  min-[660px]:scale-[1.4] min-[660px]:top-[8%] min-[660px]:left-[62%] min-[820px]:top-[5%]  transform '></span>
